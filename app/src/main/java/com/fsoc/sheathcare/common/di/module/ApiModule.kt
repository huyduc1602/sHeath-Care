...
import com.fsoc.sheathcare.common.AppCommon
...
class ApiModule(private val context: Context) {
    ...
    @Provides
    @Singleton
    @Named("covidInTheWorld")
    fun provideRetrofitCovidInTheWorld(): Retrofit {
...
//        okHttpClientBuilder.writeTimeout(20, TimeUnit.SECONDS)
    ...
    fun provideHttpHeaderInterceptor() = object : Interceptor {
        override fun intercept(chain: Interceptor.Chain): Response {
            // fake token
            val token =
                "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJhdXRoMCIsImV4cCI6MTU5MjMwMDk4NywidXNlcklkIjo0LCJ1dWlkIjoiMzg0MzdhNzE0MzVhNTk2MjRkNjU2MjU4NDczMjM2Mzk3NDc2MzY2ODQ2NzczZDNkIn0.S5POWfuY23y6isIPp3Hju9AWvYW4PGbAz8BtWLgGWhQ"
...
//            .header("Authorization", String.format("Bearer %s", token))
    ...
    @Provides
    @Singleton
    fun provideMovieApi(retrofit: Retrofit): CovidNewsApi {
        return retrofit.create<CovidNewsApi>(CovidNewsApi::class.java)
    }

    @Provides
    @Singleton
    fun provideCovidInTheWorldApi(@Named("covidInTheWorld") retrofit: Retrofit): CovidInTheWorldApi {
        return retrofit.create<CovidInTheWorldApi>(CovidInTheWorldApi::class.java)
    }
